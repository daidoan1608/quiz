...
export default function SubjectManager() {
  ...
  const [selectedSubjectIdForChapters, setSelectedSubjectIdForChapters] =
    useState(null);
  const [selectedSubjectNameForChapters, setSelectedSubjectNameForChapters] =
    useState(null);
  ...
  const handleRestore = async (subjectId) => {
    try {
      ...
      message.error(
        error.response?.data?.message || 'Cần khôi phục khoa cha trước.'
      );
    }
  };
        ...
        viewMode === 'active' ? (
          <Space>
            ...
            <Button
              ...
              disabled={!isAdmin}
              onClick={() => {
                setSubjectIdToUpdate(record.subjectId);
