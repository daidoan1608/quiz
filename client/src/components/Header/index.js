              ...
              <div className="d-flex align-items-center gap-2">
                ...
                {!isLoggedIn ? (
                  <>
                    <a
                      href="/login"
                      className="btn btn-primary btn-sm text-nowrap px-2"
                    >
                      {texts.login}
                    </a>
                    <a
                      href="/register"
                      className="btn btn-secondary btn-sm text-nowrap px-2"
                    >
                      {texts.register}
                    </a>
                  </>
                ...
                >
                  ...
                  {!isLoggedIn ? (
                    <>
                      <a
                        href="/login"
                        className="btn btn-primary btn-sm w-100 mb-1 py-1"
                        style={{
                          fontSize: "0.65rem",
                          paddingTop: "0.2rem",
                          paddingBottom: "0.2rem",
                      ...
                      <a
                        href="/register"
                        className="btn btn-secondary btn-sm w-100 py-1"
                        style={{
                          fontSize: "0.65rem",
                          paddingTop: "0.2rem",
                          paddingBottom: "0.2rem",
